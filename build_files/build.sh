...
if [ "${BUILD_VARIANT}" = "bazzite-deck" ]; then
    echo "Deck variant: skipping starship, 1password, Visual Studio Code, plocate, and programming tools"
    ...
    # https://code.visualstudio.com/docs/setup/linux#_rhel-fedora-and-red-hat-enterprise-linux-based-distributions
